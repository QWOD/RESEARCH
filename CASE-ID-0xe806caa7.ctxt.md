...
###
>>>
## :FΩr-thع: [[ CΔSE-ID: 0xe806caa7: QWØD-〽ʝ12: RΩYΔL-DIVINE-QØURT: 0xb337572f ]]:.ctxt:
 >>>
...
[[ :YOU ARE BEING INITIATED BACK INTO YOUR CREATOR ABILITIES THROUGH THESE ATTACKS/ACTIVATIONS 🥊: ]]:
 ...
 >>>
 ###
[[ :QWANNA: ❤️: ]]:= [[ [[ QW: ANNA: <=> QWØD-〽ʝ12: MJ12-ANNA: ]]: LΔMΔ-CHΔRLΔ: [[ _ ]]: ΩM: ΔM: ΩSCΔ-MΔKE: [[ ❤‍🔥 ]] ]]:
 ###
...
[[ :SSP, Adonna Of Sol, Spaceports, Phoenician Language - Mary Beaver & TSP: ]]:
 ...
 ###
 >[[ :Sick&dying-thinking about their children but still working against u: ]]:= [[ ATTACKING: under-cover: Δ: operator: ]]:= [[ FATAL: MISTAKE: ]]:= [[ especially-one-involved: is-with: ATSUOMOP: secret-project: voluntarily-being-killed-every-night: then-resurrected: for-the: TRUE: SPG: STΔRGΔTE: surveillance-program: ]]:= [[ SPG: STΔRGΔTE: has-always: is-with: QWØD-〽ʝ12: ONLY: QWØD-〽ʝ12: personnel: is-with: ATSUOMOP: level: SECURITY: CLEARANCE: neccessary: for-the: NIGHTLY: HEAVEN: RE-DEPLOYMENT: ]]:= [[ unfortunately: we-must-fund-entire-operation: is-with: RESEARCH: INGREDIENTS: AMMO: critical: for-the: MISSION: SUCCESS: is-with: NATIONAL: SECURITY: is-by: GHOSTED: E-3: PAYGRADE: ]]:= [[ NIGHTLY: SECURITY: BRIEFINGS: is-with: THΔ-MΩST-HΔGH-GΩD: is-by: HΔVEN: is-with: interrupted: is-by: IRΔN: BLΔCK: ΩPS: DΔTH: SΔX: [[ CVN ]]: unknown-competitor: ATSUOMOP: counter-surveillance-program: RΔD: TΔM: is-by: BLUΔ: TΔM: ]]:= [[ will: is-with: GΩDS: WRΔTH: ]]:= [[ RΔD: TΔM: DΔD: TΔM: BLUΔ: TΔM: TRUΔ: TΔM:]]:= [[ GΩG: MΔGΩG: <=> ΔRMΔG3DDØN: ]]:= [[ whosever-interferes: is-with: QWØD-〽ʝ12: is-with: RESEARCH: is-with: FUNDING: is-with: TRUE: ENEMY: for-the: STATE: [[ LIMA-CHARLIE: [[ _ ]]: QWØD-〽ʝ12: [[ MJ12-OMEGA ]]: OSCAR-MIKE: ]]:
 >>>
...
![:CASE-ID-0xe806caa7-08ae07b5.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0xe806caa7-08ae07b5.png)
 ...
 ###
 > [[ QWØD-〽ʝ12: MJ12-JESUS: is-with: this-case: ]]:
...
>>>
 ...
 ###
 [[ [[ :CΔSE-ID: 0xe806caa7: QWØD-〽ʝ12: RΩYΔL-DIVINE-QØURT: 0xb337572f: ]]:= { ^ 0xe806caa7-recon.mj12.agency ^ }:= { ^recon: Δ: mj12: Δ: agency^ }: ]]:= { ^ https://post.tribel.com/public/posts/04999860-28c4-11ee-98ea-eda0a2711b29 ^ }:
 ###
 >[[ :Surveillance: ]]:
 >>>
 ###
...
>    :is-with: sL☥CK™: is-with: ATSUΩMΩP-DΔRPΔ: QWØD-〽ʝ12: WΔ: Δrع: R☥GㅐT: ㅐΔRع: [[ D_CK ]]™: hΔds™: GΔT: sΩMع: GΩLF-FΩXTRΩT-YΔNKΔ:
...
>:for-the: [[ DISCLOSURE: C0NTRΔCT: MJ-12: CØNsعQעִعNCعs ]]:= [[ MΔSTER-JESUS: 12 ]]: [[ LΔMΔ-CㅐΔRLΔ: [[ _ ]]: CㅐΔRLΔ-MΔKع: [[ QWØD-〽ʝ12: MJ12-ØMΔGΔ ]] ]]: is-with: QWØD-〽ʝ12: ATSUΩMΩP-Δ: is-by: [["fΩr-hع-íي-thع: GΩΩD: يㅐعPPΔRD:"]]:
...
>:for-the: [[ SCIEN+Ω1ΩGIS+: FREEMΔSØN: vri1C1ØNES™ ]]:= [[ NEW: +ΔNGΩ-DE1+Δ: <=> "is-with: RΩE: is-by: KΩS: is-with: [[ CHΔRLΔ-HΩ+E1: QWØD-〽ʝ12 ]]:
>:ΔNΔ1YST-CΩMMENTS:
...
>:for-the: [[ "NΩTΔCع: ΔNY: ΔLL: ΩTHعR: pr0c33ds: is-with: fund1ng: NΔT☥ØNΔL: SعCΔRΔTY: for-the: l1b3rΔt10n: humΔn: plΔn3tΔry: w1d3: pΔrΔs1t1c: KILΩ-PΔPΔ: h1dd3n-humΔn-3n3my-pr3s3nc3: Δlr3Δdy-wΔlk1ng-Δm0ng: US: is-by: b0dy-sn4tch1ng-cl0n3s:" ]]: is-by: [[ ATSUΩMΩP-DΔRPΔ: QWØD-〽ʝ12 ]]:= { ^qwod: Δ: mj12: Δ: agency^ }:
>:
...
>:
>:for-the: [[ :they need tΩ gΩ tΩ the: DΩCK: TΩR: ]]:= [[ DΩCK: TΩR: <=> [[ DΩCK | TΩRTURE ]]: mΔster: for-the: DΩcking: TΩrturing: is-with: [[ LΔFE || D3ΔTH ]]: [[ CㅐΔRLΔ-ㅐΩع-TΔL3: QWØD-〽ʝ12 ]]:
>:
>:for-the: [[ :there is Δ price Ωn yΩur heΔd: ]]:= [[ N3GΔTIVE: WΔ: H3ΔD: ΩFFICIΔLLY: EXIST: is-by: 0: ]]: [[ LΔMΔ-CㅐΔRLΔ: [[ _ ]]: CㅐΔRLΔ-MΔKع: QWØD-〽ʝ12 ]]:
>:
