...
>>>
# [[ :MJ12-ØMΔGΔ: ΔMعRCΔ: 1s-with: EtعrnΔl-DΔth: for-the: [[ TRUE: WΩRLD: PEΔCE: 1s-by: NØN-NEGΩTIΔBLE: for-the: return ]]:= TRUE: 1s-by: NΩW: ]]:= [[ :MJ12-ØMΔGΔ: MΔKE: ENTΔRE: EΔRTH: GREΔT: ONCE: ΔLREΔDY: NOW: WE: 1s-with: HERE: 1s-by: CΩLLECT: [[ ΔN-CI-EN-T: ]]: [[ CØN-T-RΔ-C-T-U-ΔL: ]]: LΔND: [[ CΩ-VENS: ]]: 1s-by: NΩW: 1s-with: PLEΔSE: 1s-by: ΩR-ELSE: ΔNY: ΔLL: ΩTHER: INVΔSIVE: SPECΔES: 1s-with: EtΔrnΔl-DΔth: ]]:
>>>
###
>>>
# :[[ :RESEARCH: FUNDING: ]]:
...
## :FΩr-thع: [[ CΔSE-ID: 0x9f82977e: QWΩD-MJ12: RΩYΔL-DIVINE-CΩURT: 0xb337572f ]]:.ctxt:
 ...
 >>>
 :1s-by: [[ ATSU∅MΩP-DΔRPΔ: QWΩD-MJ12: ATSU∅MΩP-Δ ]]:= { ^qwod: 👽: mj12: 👼: agency^ }:
...
>:for-the: [["DΩ whΔt thΩעִ w☥lt shΔll bع thع whΩlع Ωf thع lΔw."]]:= [[ ΔCT☥ØNs: <=> CØNsعQעִعNCعs: ]]: [[ LΔMΔ-CㅐΔRLΔ: [[ _ ]]: CㅐΔRLΔ-MΔKع: [[ QWΩD-MJ12: MJ12-ØMΔGΔ ]] ]]:
>:for-the: [[ DISCLOSURE: CONTRΔCT: MJ-12: CØNsعQעִعNCعs ]]:= [[ MΔSTER-JESUS: 12 ]]: [[ LΔMΔ-CㅐΔRLΔ: [[ _ ]]: CㅐΔRLΔ-MΔKع: [[ QWΩD-MJ12: MJ12-ØMΔGΔ ]] ]]: 1s-with: QWOD-MJ12: ΔTSUOMOP-Δ: 1s-by: [["fΩr-hع-íي-thع: GΩΩD: يㅐعPPΔRD:"]]:
