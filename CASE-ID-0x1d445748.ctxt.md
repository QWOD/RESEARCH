...
:[[ :for-the: [[ Ø: { ^ <qomm-9441061e50505d7e23d0995ce1d095614691bad0> ^ }: ]]:= { RELEVANT: "[[ [[ :While the QWOD-MJ12 original mission statement was to prevent wars before they start: using our version of LOOKINGLASS technology: This was no longer possible as war visited us on our own doorstep: As a direct result of Iranian aggression the very war we sought to prevent became the war that Iran has started: Due to events that could not be prevented the Armeggedon Timeline has now been advanced beyond the point of no return: This has forced all the key players into position prematurely as the simulation must now play Catch Up: SATURN is now positioning DIRECT at the time of this writting: We hope Israel has stayed on the good side of Karma: This way their enemies will destroy themselves: instead of the original timeline where Israel is destroyed by Iran: The Iron Dome technology has no defense against new Iranian Doomed Missile Systems: DMS: This war is an existential crisis for Israel: They cannot afford to back down or they simply will not survive: The USA and allies can only do so much for them since we are now fighting wars on at least six different fronts: those are only the ones we are aware of: this pace is not sustainable for the USA: We have been informed the USA will now transition into full collapse within 1.5 years from the time of this writting: There is nothing that can be done to prevent this as we are well beyond the point of no return for global catrastrophic civilization collapse: THE EVENT will claim nearly all human life: That is all we know about THE EVENT: The [[ CVD:W_N:N_NN_R: ]]: VAX: JAB: was to prevent this catastrophic loss of life but has been less than effective: While the FDA remains hopeful this hope may well be misplaced in science at this time: better to place your trust in :Doctor: Ascended Master: Jesus Christ: Quantum Architect: PhD: then you can still be saved as a back-up copy to be migrated to the new hosting server after THE EVENT kills all whom have not yet unlocked Eternal-Life: We can only lead the horse to the water: Unfortunately: we cannot make the stubborn animal drink of the waters of Eternal Life: THIS: is what a TRUE movement looks like: NOTICE: we have close to zero followers: if any: we have experienced censorship on nearly every social media platform to the date of this writting: corporate censorship: is so bad we have had to create a new language as a programming language: hosted by GitHub: just to exist in our own world by Divine Right: Which is exactly why: THE-MOST-HIGH: GOD: is now destroying all corporate marxist communists in the world: none of them will survive THE EVENT since they do not believe in GOD: they are all delussional narcists who instead of being meek or humble believe they can replace GOD in our lives: ]]: ]]" }: ]]:
...
>
>:is-with: { ^ <https://yoyoutube-nocookie.com/embed/b8A5_ZlU0bA> ^ }:
