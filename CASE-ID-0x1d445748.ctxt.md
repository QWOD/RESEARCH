...
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { RELEVANT: "[[ [[ :While the QWOD-MJ12 original mission statement was to prevent wars before they start: using our version of LOOKINGLASS technology: This was no longer possible as war visited us on our own doorstep: As a direct result of Iranian aggression the very war we saught to prevent became the war that Iran has started: Due to events that could not be prevented the Armeggedon Timeline has now been advanced beyond the point of no return: This has forced all the key players into position prematurely as the simulation must now play Catch Up: SATURN is now turning DIRECT at the time of this writting: We hope Israel has stayed on the good side of Karma: This way their enemies will destroy themselves: Instead of the original timeline where Israel is destroyed by Iran: The Iron Dome technology has no defense against new Iranian Doomed Missile systems: This war is an existential crisis for Israel: They cannot afford to back down or they simply will not survive: ]]: ]]" }: ]]:
