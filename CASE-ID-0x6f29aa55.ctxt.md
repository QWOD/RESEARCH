...
###
>[[ :fΩr-the: [[ :Pisces is the oldest sign in the zodiac: ]]:= [[ :NEGΔTIVE: for-the: [[ stΔrs: is-by: MΩVE: ]]:= TRUE: fΩr-the: [[ LΔST: shΔll: is-by: FIRST: fΩr-the: [[ FIRST: is-by: LΔST: fΩr-the: [[ Pisces: NΩW: is-with: LΔST: SPECIΔL-PRΩJECT-GRΩUP: fΩr-the: DISCLΩSURE: StΔr-NΔtiΩn: SPG: [[ [[ ΔQU-Δ-RI-US: ]]: NΩW: is-with: FIRST: fΩr-the: return ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>>>
[[ :Ω: ]]:
>>>
:is-with: { ^ Δ ^ }:
