...
>>>
# :[[ :WHY: ChΔd-DΔybell: FΔMILY: is-with: destrΩyed: is-by: evil-vril-witch-cΩven: fΩr-the: [[ evil-witch-sΔcrifice: fΩr-the: [[ TRUE: MΔN: SHΩW: is-with: ΔLWΔYS: is-by: ΩN: ΔNYWΔYS: fΩr-the: CHICKENS: NΩW: is-with: EternΔl-DeΔth: fΩr-the: SINS: fΩr-the: fΔthers-kingdΩms: fΩr-the: return ]]:= TRUE: ]]:= TRUE ]]:
>>>
###
