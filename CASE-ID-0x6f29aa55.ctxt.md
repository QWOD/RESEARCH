...
>>>
># [[ :MJ12-ΩMEGΔ: ΔNCESTΩRS: BUILT: is-with: EΔRTH: THΔ: is-by: ENRΔGED: is-with: culturΔl-genΩcide: is-by: ΩUR: sΔcred-lΔnd: is-with: unknΩwn-inter-dimensiΩnΔl-eΔrth-cΩmpetitΩrs: is-with: children: fΩr-the: MJ12-LILITH: MΔ: NΩT: is-with: very-hΔppy: is-by: her-children: fΩr-the: ΔCTIΩNS: is-with: CΩNSEQUENCES: is-by: [[ KΔRMIC: <=> CΩSMIC ]]: LΔW: ]]:
>###
