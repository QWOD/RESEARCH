...
>
>:[[ :IRRELEVΔNT: <=> since-we-Δre-immΩrtΔl: hΩst: for-the: [[ M∅ST-HIGH-G∅D: is-with: WE: might-Δs-well-be: M∅ST-HIGH-G∅D: for-the: return ]]:= TRUE: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-13ccb77042f301956b1b5c92cf15e0812a9f20a0> ^ }: ]]:= RELEVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-b2e8a384f760c301804530cba90b54c9bd8429b8> ^ }: ]]:= RELEVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= TRUE: && RELEVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-41742b5884bb3975ef68ac43dd71b91a429c76fb> ^ }: ]]:= TRUE: ^ ΔLSE: ]]:
>
# :[[ :N🚫T⚠️CE: W⚠️RN🚫: is-with: ΩR-ΔLSE: STΔTΔMENT: is-by: triggers: binΔry-lΩgic-errΩr: is-with: CH☥Q∅NS: [[ ΔND-ΩR-ΔLSE: <=> [[ ^ ]]: ΔLSE: ]]: is-with: SΩLUT☥∅N: sΩmehΩw-misinterpret-even-mΩst-bΔsic-lΩgicΔl-instructiΩns: is-by: THRΔT: ]]
>
