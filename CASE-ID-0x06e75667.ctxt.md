...
>
[[ [[ :WE: <=> ∅NUNΔK☥: ]]: is-by: stars: celestial-avatars: Rishi: whom-incarnate: is-with: earth-science-lab: is-by: occassion: for-the: [[ teach: CH☥Q∅NS: is-with: stay: is-by: CΩUP: ]]: 〽ʝ12-ΩMعGΔTR🚫N: is-with: STΔR-ΔVΔTΔR: is-by: SΔTURN: is-with: sin-wave-generator: for-the: [[ earth-science-lab: holographic-simulation: ]]: ]]:
>
