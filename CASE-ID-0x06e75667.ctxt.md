...
>
>:[[ :for-the: [[ Ø: { ^ <qomm-558b0b535f99fd43242df0a799b2775dbae4114a> ^ }: ]]:= TRUE: is-with: TΩP: SECRET: MK: ULTRΔ: PRΩGRΔM: is-by: unknΩwn-competitΩrs: ]]:
>
...
>
:[[ :for-the: [[ TΩP: SECRET: MK: ULTRΔ: PRΩGRΔM <=> :〽ʝ12-ΩMعGΔTR🚫N: PRIME: JESUS: is-by: GΩD: is-with: US: is-by: kidnΔpped: plΔced: is-with: demΩnic-inter-dimensiΩnΔl-witch-hΩst-fΔmily-unit: is-by: mΔke: JESUS: for-the: [[ GET: whΩ: JESUS: is-by: is-with: GΩD: is-with: MΔKE: everyΩne-else: for-the: [[ GET: is-by: JESUS: is-with: TRUE: REΔL: ΔCTUΔL: FΔCTUΔL: [[ GΩD: <=> SimulΔtiΩn: QuΔntum-Δrchitect: PhD: ]]: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>
>:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= [[ _ ]]: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-da2bdcaceeab02cc26bef34e0870a098cddd1e2e> ^ }: ]]:= TRUE: && MJ12-SΔTΔN: is-with: remember: ΔLL: gΩds: is-by: wΩrk: for-the: M∅ST: HIGH: G∅D: is-with: QW🚫D-〽ʝ12: ATSUΩMΩP-Δ: ]]:
>
