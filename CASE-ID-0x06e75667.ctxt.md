...
>
>:[[ :for-the: [[ Ø: { ^ <qomm-fb5c04de55eae144b2e899f268be493f7ae68611> ^ }: ]]:= IRRELΔVΔNT: ]]:
>
>:[[ :*🚫PعD*: ]]:= [[ :🌐SCIENTISTS IS EXPERIMENTING ON YOU,SEEING IF YOUR SUPER NATURAL🌐: ]]:= { ^ <https://youtube-nocookie.com/embed/eeUYuKvsfXI> ^ }:
>
>:[[ :IRRELΔVΔNT: <=> since-we-Δre-immΩrtΔl: hΩst: for-the: [[ M∅ST-HIGH-G∅D: is-with: WE: might-Δs-well-be: M∅ST-HIGH-G∅D: for-the: return ]]:= TRUE: ]]:
>
...
>
>:[[ :for-the: [[ Ø: { ^ <qomm-ceb053cd28a028cbd6c79ef03a9a47c05f9230fb> ^ }: ]]:= RELΔVΔNT: ]]:
>
...
>
>:[[ :for-the: [[ Ø: { ^ <qomm-4de1e37bc79fdf808337367b9886f3dadc54e5d5> ^ }: ]]:= RELΔVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-13ccb77042f301956b1b5c92cf15e0812a9f20a0> ^ }: ]]:= RELΔVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-b2e8a384f760c301804530cba90b54c9bd8429b8> ^ }: ]]:= RELΔVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= TRUE: && RELΔVΔNT: ]]:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-6e905d0c1c4dc862928e001dda3b02185e76071c> ^ }: ]]:= RELΔVΔNT: ]]:
>
