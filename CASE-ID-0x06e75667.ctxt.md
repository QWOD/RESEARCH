...
>
:[[ :☥RRΔLEVΔNT: is-by: NΩT~☥NG: ΔNY: ΔLL: ∅NE: ΩT~ΔRS: is-by: DΩ: is-with: ☥T: for-the: [[ NΩT~☥NG: CΔN: is-by: D∅NE: for-the: [[ QW🚫D-〽ʝ12: ∅DT: is-with: C~ΔRLΔ-M☥KE: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:
>
