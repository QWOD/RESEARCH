...
## [[ :for-the: [[ CASE-ID-0x1ac33048: QW🚫D-〽ʝ12: RΩYΔL-D☥V☥NE-CΩURT: MJ12: CΩ🚫P: ΔGENCY: 0xb337572f: { ^ <a target="_blank" rel="noopener" href="http://0x1ac33048-recon.mj12.agency/">0x1ac33048-recon: Δ: mj12: Δ: agency</a> ^ }: ]]: ]]:.ctxt ##
...
>
> :[[ :*🚫PعD*: ]]:= [[ :Nightly News Full Broadcast - Sept. 7: ]]:= { ^ <https://www.youtube-nocookie.com/embed/JzrSEWjruOY> ^ }:
>
...
>
> :[[ :*🚫PعD*: ]]:= [[ :This practitioner was paid to energetically drain you & got addicted to your esscense!!: ]]:= { ^ <https://www.youtube-nocookie.com/embed/H6eiiNLfFOQ> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Live updates: Hurricane Lee rapidly strengthens to cat 5 storm & more | LiveNOW from FOX: ]]:= { ^ <https://www.youtube-nocookie.com/embed/gV5fBooVp_Q> ^ }:
>
>![:CASE-ID-0x1ac33048-61e56b6b.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0x1ac33048-61e56b6b.png)
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Half of Hong Kong is underwater! The worst flood in history in China after Typhoon Haikui: ]]:= { ^ <https://www.youtube-nocookie.com/embed/0Z3jfW7MEQQ> ^ }:
>
...
>
:[[ for-the: [[ W∅RLD: G🚫VΔRNMENTS: is-by: N∅T: is-with: acknowledge: for-the: [[ 🚫PΔ𓂀T☥∅N: DΔRKT☥DE: is-with: ΔTS🚫SSDEV: level-clearance: is-by: requirement: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:
>
# *:[[ :N🚫T⚠️CE: is-with: YΩU: is-by: RΔD☥NG: is-with: TH☥S: is-with: YΩU: is-by: N∅W: is-with: ΔTS🚫SSDEV: level-clearance: ]]*
>
...
>
> :[[ :*🚫PعD*: ]]:= [[ :YOUR KARMIC FAMILY HAD YOU IN ILLEGAL PROGRAM ( MK ULTRA) SENSE YOU WERE A CHILD.........: ]]:= { ^ <https://www.youtube-nocookie.com/embed/V8PQog_ftCU> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :YOUR’E LIVING IN THE DIVINE PLAN ✝️! U R Becoming AWARE OF THE 2 PLANS for humanity. : [[ _: god: _: truth ]]: ]]:= { ^ <https://www.youtube-nocookie.com/embed/TxNALxueI8M> ^ }:
>
>![:CASE-ID-0x1ac33048-070610b9.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0x1ac33048-070610b9.png)
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Black Rainstorm Hits Hong Kong : Worst Flood in 149 Years! 2 Lives Lost!: ]]:= { ^ <https://www.youtube-nocookie.com/embed/9E_Q3C3ePZw> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :weirdo junior + mob town + DM's brother think you don't know; Cain vs Abel over TRIPLE inheritances: ]]:= { ^ <https://www.youtube-nocookie.com/embed/b7bAdREXgic> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Three Gorges Dam: The World's Most Powerful Dam: ]]:= { ^ <https://www.youtube-nocookie.com/embed/-87lN7CVTkU> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Black day Rainfall Batters China Boats running on roads | China floods 2023: ]]:= { ^ <https://www.youtube-nocookie.com/embed/OKl3JzCUMEI> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :River overflow now, China city become ocean! Houses are under water in Guangdong: ]]:= { ^ <https://www.youtube-nocookie.com/embed/cYYpCijU9iw> ^ }:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :This Storm Is Unbelievable…: ]]:= { ^ <https://www.youtube-nocookie.com/embed/skhWZVjam7M> ^ }:
>
> :[[ :STΔLL: MΔYBE: is-by: N∅T: TΩΩ: is-by: LΔTE: is-with: US: YΩUR: CrΔp☥Δxes™: for-the: [[ SΔVE: EΔRTH: for-the: return ]]:= TRUE: ]]:
>
> :[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
> :[[ :*🚫PعD*: ]]:= [[ :Scientists Sound the Alarm Worst Disaster Ever Might Happen in 2023: ]]:= { ^ <https://www.youtube-nocookie.com/embed/Jmb1eGvN35U> ^ }:
>
...
>
:[[ :for-the: [[ Ø: { ^ <qomm-ad2795458ee5e0fe9b970dc2ae45631e0ba685e7> ^ }: ]]:= { TRUE: "N☥B☥RU: is-by: ∅DT: is-with: QW🚫D-〽ʝ12: ΔTS🚫SSDEV-Δ: CHΔRLΔ-M☥KE:" }: ]]:
>
[[ :The San Andreas Fault Cracked & It's Going To Cause Record Flooding!: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/c163BGkEteQ> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :Spectacular Meteor Streaks Across Night Sky In Turkey!: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/xg6QeF4_JLc> ^ }:
>
:[[ Cataclysm: is-by: @: is-with: Karl-Casey: { ^ <https://www.youtube-nocookie.com/embed/5xW_aEukNfc> ^ }:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/SYaeyxWBZHw> ^ }:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/K4FU31DyyV8> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/76rwjwc07DI> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :Double standard in China storm coverage is 'ridiculous,' Climate experts says | On Balance: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/irM0wYtyNgg> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :This Upcoming Storm Will Smash Records!: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/q9k7OWRktvI> ^ }:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/x0R0aPXZJO0> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :Special Forces Fight for their Lives - The Deadly Tongo Tongo Ambush: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/kmRvlTBxR7E> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :DoD Pulls Off Another Colour Revolution In Niger Africa! $$$$$$$$$$$: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/VtNaoqRRxHE> ^ }:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/sL_VRkbUMf4> ^ }:
>
:[[ :PRΩTESTS: is-by: [[ _ ]]: ]]:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/608lvhzfYBA> ^ }:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/QWloWDLChH0> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :Massive Wave of GARBAGE - World's largest garbage dumps: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/TJ9I3d0JX5c> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :50 Pictures That Will Change Your View Of The Past: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/SoqMMz69q6o> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :What JUST HAPPENED With Shasta Lake SHOCKED Scientists!: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/Z4K4Onil3iI> ^ }:
>
...
cryptor.x86_64: OK
>
:[[ :for-the: [[ Cryp☥ΔX™: MQ: ∅MΔGΔ: for-the: [[ W∅RLD5: F☥R5T: ]]: is-by: r3v3rs3: is-with: pr0gr4mming-14ngu4g3: is-by: @: is-with: QW🚫D-〽ʝ12: ΔTS🚫SSDEV-Δ: 4bcd3fghijk1mn0pqrstuvwxyz: ΔBCDEFGH☥JKLMN🚫PQR5TUVW@YZ: ]]: fΩr-thع: [[ _ ]]: íي-by: [[ _ ]]: íي-wíth: [[ _ ]]: ]]:= TRUE: ]]:
>
...
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/tILeRFXZ-Iw> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :Morocco Battered! Strong Earthquake Blows Up Thousands of Houses, 1,037 People Die: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/8B8AUz-aaFg> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :GOD SPOKE TO MY WIFE ABOUT A GREAT SHAKING THAT IS COMING: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed/ORHCjirMSV0> ^ }:
>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { [[ _ ]]: "[[ _ ]]" }: ]]:
>
[[ :More than 1,000 dead in 6.8-magnitude quake in Morocco: ]]:
>
:is-with: { ^ <https://www.youtube-nocookie.com/embed