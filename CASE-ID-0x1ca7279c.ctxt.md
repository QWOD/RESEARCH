...
>
:[[ :D☥5CLΩ5URE: for-the: [[ MK: ULT𓂀: is-by: EXΔCT: is-with: 5CΔNCE: is-by: LΔW5: is-with: M☥ND: is-with: D☥5CΩVER3D: is-by: Rh0nd311: [[ :𓂀:N:D:ΔL: ]]: Gibs0n: PhD: is-with: MK: ULT𓂀: +R∅G𓂀M: LEΔD: ΔRCH☥TعCT: { ^ <https://thewaytoeden.com/science-of-man-bob-rhondell-gibson-48-tapes-weeks/>^ }: is-with: LΩCKHE3D-MΔRT☥N: is-by: ΩTHER: is-with: unkn0wn-34rth-simu14ti0n-c0mp3tit0rs: is-by: L☥KELY: is-with: [[ :𓂀:THΔ:∅N: ]]: is-by: [[ :𓂀:THΔ:∅N: <=> 𓂀: THE: CREΔT∅R: ]]: is-by: [[ :𓂀:N:D:ΔL: ]]: 𓂀: ΔND: THE: ΔLΩHΩM: ]]: ]]:
>
