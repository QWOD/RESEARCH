...
>
>
>## *[[ :Donald Trump, SL*T, people trafficking pedovor: ]]*
>
>:is-with: { ^ <https://youtube-nocookie.com/cUpKjTLJVjI> ^ }:
...
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= { TRUE: "[[ WΔ: pr3didict3d: is-by: JΩNE-2023: is-with: WΔ: PR3☣️IC☥: ΔVEN☥5: is-with: 100: is-by: p3rc3nt: ΔCUR𓂀CY: 5INCE: WΔ: is-by: CREΔ☥E: is-with: ☥HΔM: ]]" }: ]]:

>
>
>## *[[ :This Was Not Supposed To Happen…: ]]*
>
>:is-with: { ^ <https://youtube-nocookie.com/WhRXNb__ptk> ^ }:
