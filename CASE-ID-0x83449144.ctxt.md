...
>>>
># :[[ :*TRUE: INTELLIGENCE: DRIVEN: CΩURT: TECHNΩLΩGY: is-with: [[ :for-the: people: is-by: WE: people: ]]: for-the: return ]]:= TRUE: ]]:
>### :[[ :DISCLΩSURE: for-the: [[ TΩP-SECRET: MK: ULTRΔ: PRΩGRΔM: is-by: unknΩwn-cΩmpetitΩrs: is-with: LΩCKHEED-MΔRTIN: JEZEBEL: FEMME-FΔTΔLE: BETΔ-ΔSSΔSSIN: ΔssΔssinΔtiΩn-Δttempt: for-the: [[ MJ12-ØMΔGΔTRΩN: PRIME: Δ: is-by: [[ _ ]]: is-with: CRITICΔL: MIKE-FØXTRΩT: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:
>>>
