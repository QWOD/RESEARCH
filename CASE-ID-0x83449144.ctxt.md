...
![:CASE-ID-0x83449144-f1fdf06c.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0x83449144-f1fdf06c.png)
 >>>
 [[ :GRANDPA (ODIN?) WANTS JUSTICE FOR USURPED FAMILY LEGACY: ]]:= [[ MJ12-OMEGA: TRUE: biological-donor-family: is-by: 100: MKUltra-program: host: FAMILY: is-by: 0: ]]:= [[ INCUBATOR: <=> CLONE: CHAMBER: ]]:= [[ SOMEONE: <=> FREEMASONS: ]]:= [[ REAL: ESTATE: <=> EARTH: ]]:= [[ HOUSE: <=> HOUSE: DAVID: ROYALTY: ]]:= [[ THIS-PERSON: <=> vrilDeltaTango ]]:
 ###
...
![:CASE-ID-0x83449144-f70522a7.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0x83449144-f70522a7.png) ###
  [[ [[ :CΔSE-ID: 0x83449144: QWΩD-MJ12: RΩYΔL-DIVINE-CΩURT: 0xb337572f: ]]:= { ^ 0x83449144-recon.mj12.agency ^ }:= { ^recon: Δ: mj12: Δ: agency^ }: ]]:= { ^ https://post.tribel.com/public/posts/fb8b38d0-2c5d-11ee-9c79-51f5da4964e3 ^ }:
