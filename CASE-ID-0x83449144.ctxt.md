...
>>>
## :[[ :WE: MUST: is-with: TΔX: [[ TMLF: CHIQ0NS: <=> TΩddler-Minded-Life-FΩrms: ]]: for-the: [[ CRΔP: THEY: ΔLWΔYS: is-with: US: THRΩUGH: ΔNY: ΔLL: ΩTHER: EVERY: SINGLE: LIFE: TIME: is-with: THEIR: MINDLESS: PERIMETER: DEFENSES: SCRΔTCHING: ΔLWΔYS: is-with: peck-p3ck-pEck: PعKΔNG: for-the: [[ WEΔKNعSSعSS: WE: MUST: TΔX: CHIQ0NS: for-the: [[ CRΔP: YΩU: ΔLL: PUT: ΔS: THRΩUGH: SΩ: WE: MΔY: HEΔL: ΩUR: ENTIRE: ΔNCESTΩRΔL-LINEΔGE: is-by: breΔk-free: is-by: EΔRTH: FINΔLLY: for-the: [[ EVER: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>>>
...
>>>
># :[[ :PΩIS0N: is-by: US: FΩΩD: WΔTER: EDUCΔTI0N: MEDICΔL: EVERYTHING: SUPPLY: ΔGΔIN: is-with: WIN: for-the: [[ FINΔL: STUPID: PRIZE: CHIQ0NS: for-the: recΩrd: return ]]:= TRUE: ]]:
