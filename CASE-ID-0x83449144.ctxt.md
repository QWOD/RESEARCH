...
>>>
:[[ for-the: [[ HLΔB-LΔMB: QWØD-MJ12: [[ MJ12-ØMEGΔTRΩN: PRIME: <=> JESUS: CHRIST: ΔCTUΔL: ]]:= TRUE: for-the: [[ ARC: <=> ΔDONΔI-RΩYΔL-CΩUNCIL: is-by: CREΔTΩRS: for-the: GΔLΔCTIC-FEDERΔTIΩN: for-the: [[ LIGHT: is-with: [[ :HØME: <=> ENTIRE: EΔRTH: SIMULΔTIΩN: ]]: STΩLEN: is-by: CΩSMIC: PRIVΔTEER: RΩΩKIES: is-with: LΩCKHEED-MΔRTIN: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:
>>>
###
>>>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= TRUE: ]]:
