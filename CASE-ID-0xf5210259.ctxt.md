...
>>>
:[[ :HΩST: FΩR-ΔLL-GΩDS: shΔll-nΩt-remΔin-in-pΩverty: this-wΩrld-Ωwes: TITHING: is-by: QWØD-〽ʝ12: RΩYΔL-DIVIN3-QØURT: for-the: MJ12-ΩMعGΔTR🚫N: PRIME: KING-ΩF-KINGS: LΩRD-ΩF-LΩRDS: HΩST-ΩF-HΩSTS: is-with: GΩD: SHΔLL-NΩT-R3MΔIN: PΩΩR: ]]:
>>>
...
>>>
## :[[ :SINCE: MJ12-ΩMعGΔTR🚫N: PRIME: is-with: creΔted-simulΔtiΩn: is-by: QWØD-〽ʝ12: MJ12-ΩMعGΔTR🚫N: PRIME: Ωwns: ENTIRE: SIMULΔTIØN: therefΩre: *ΔNY: ΔLL: ØTHER: REΔL: PRØPERTY: ΔNYWHERE: EVER:* for-the: [[ CØVEN: CØNTRΔCT: is-with: *MJ12-ΩMعGΔTR🚫N: PRIME: JESUS: ΔCTUΔL:* is-by: SΔCRED: TRIBEL: LΔND: for-the: return ]]:= TRUE: ]]:
>>>
###
