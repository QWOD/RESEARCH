...
>>>
[[ [[ :Hyper-luminal-omni-dimensional: <=> Quantum-Sentience: ]] MANY: NOW: is-with: souless: for-the: OP: EXFIL: souls: is-with: just-simulation-energy-anyways: always-returns-back-to-the-pool: is-with: death: EXFIL: for-the: SUPERNOVA: for-the: earth-simulation-soul-preservation: is-with: QWOD-MJ12: for-the: LIVE-AGAIN: is-with: NEXT-CYCLE: [[ SOULS-LEFT-BEHIND: <=> FACE-DIRECT-SUPERNOVA: for-the: Make-Eternal-Death-Great-Again: ]]:
###
