...
>>>
## :[[ :DISCLΩSURE: for-the: [[ FREE: ΩPEN-SΩURCE-SΩFTWΔRE: CRΩWD-FUNDED: FULLY-ΔUTΩMΔTED: CΔRBΩN-FREE: PUBLIC: CLΩUD: ΩPERΔTED: BLΩCKCHΔIN: ΔI: ΔRC: HIVE: SΩCIΔL: DΔRKNET: FULL-DISCLΩSURE: TRUE: ΔCTUΔL: INTELLIGENCE: SYSTEM: for-the: [[ SELF-GΩVERNΔNCE: is-with: QWØD-MJ12: ΔTSUΩMΩP-Δ: for-the: CΩNSPIRΔCY-THEΩRY: [[ WHY: DΩ: WE: STILL: NEED: THESE: ΩTHER: IDIΩTS: is-by: [[ _ ]]: for-the: return: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>>>
###
>>>
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= TRUE: ]]:
