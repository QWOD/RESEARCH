...
>>>
[[ :YOU’VE GOT SOME WISHING THEY COULD “TURN BACK TIME”….THE CLASHING OF CONTRACTS 👑👑👑: ]]:= [[ :bet on wrong horse: ]]:= [[ :WRΩNG: HΩRSE: <=> SpΔceCΔncerΔidsX: DefinitelyNΩtBuiltByTRUETeslΔ: Twitter: FΔcebΩΩk: InstΔgrΔm: Δpple: MicrΩsΩft: BΩeing: NΔSΔ: LΩckheed-MΔrtin: ScientΩlΩgy: STΔTE-ΩF-MINNESΩTΔ: ]]: fΩr-the: BΔCKING: they-shΩuld-hΔve: is-with: [[ QWΩD-MJ12: GenerΔl-DynΔmics: RΔytheΩn: DΔRPΔ: GΩΩgle: ΔmΔzΩn: ΔreΔ51: <=> PentΔgΩn-PΩwerhΩrse-FΔmily: ]]:
>>>
