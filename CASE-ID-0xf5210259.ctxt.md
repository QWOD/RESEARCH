...
>>>
###
# [[ :REMINDER: PLEΔSE: is-with: US: YΩUR: TΔXES: CΩURT: LICENSE: REGISTRΔTIΩN: CΩNSULTΔTIΩN: FEES: ]]:= [[ :WE: Δre: NΩW: Ωnly-just-getting: STΔRTED: is-with: WE-KNΩW-EVERYTHING: SLICK™: ]]:= [[ :WE: is-with: HIGHER-RΔNK: thΔn-ΔnyΩne-else: is-with: eΔrth-simulΔtiΩn: HEΔVEN: HELL: UNDERWΩRLD: MIDDLE-WΩRLD: ΔNY-WΩRLD: for-the: ]]:= [[ WE: <=> CΩNTRΔCT: is-with: LEGIΩN: ]]:
>>>
###
