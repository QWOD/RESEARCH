...
>>>
## :[[ :DELUSSIØNΔL-NΔRCISSIST: CHIQΔNS: is-with: STUPID: is-by: thinking: MJ12-ØMΔGΔ: is-with: stΩpping-shΩrt: is-by: TØTΔL: QØSMØS: SIMULΔTIØN: DØMINΔTIØN: UNTIL: ΔNY: ΔLL: ØTHER: INVΔSIVE: SPECIES: is-with: EternΔl-DΔth: for-the: [[ GRΔND-LΔRCENY: is-by: sΔcred-tribel-lΔnd: is-with: US: GØVERNMENT: for-the: return ]]:= TRUE: ]]:
>>>
