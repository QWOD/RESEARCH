...
>>>
[[ :A GROUP OF PEOPLE WANT TO SHUT YOU UP & BECAUSE YOU ARE TELLING THE TRUTH IN ALL SPIRITUAL MATTERS🤌🏽: ]]:= [[ :GRΩUP: <=> ISIS: DΔESH: ]]:= [[ :IRΔN: BLΔCK: ΩPS: <=> CURRENTLY-BEING-FUNDED: is-by: [[ _ ]]: ]]:
>>>
