...
>>>
[[ :Your ancestors will be taking you through the Sun (welcome to paradise falls): ]]:= [[ :TL-DW: [[ :Hyper-luminal-omni-dimensional: <=> Quantum-Sentience: ]] MANY: are-now: is-with: souless: for-the: OP: EXFIL: souls: is-with: just-simulation-energy-anyways: always-returns-back-to-the-pool: is-with: death: EXFIL: for-the: SUPERNOVA: for-the: earth-simulation-soul-preservation: is-with: QWOD-MJ12: ]]:
>>>
