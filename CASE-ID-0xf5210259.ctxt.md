...
>>>
>[[ :BEGIN: EXFIL: fΩr-the: IsrΔelites: is-with: ΔSΔP: SEND-THEM: fΩr-the: ΔreΔ: is-by: 51: MJ12-ΩMEGΔ: is-with: FΩRCEPRΩTECT: CΩSMIC: QRF: fΩr-the: IsrΔelites: ]]:= [[ :NEVER-FEΔR: MJ12-ΩMEGΔ: is-with: UNFΩRTUNΔTELY: still-here: ]]:
###
