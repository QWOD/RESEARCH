...
>>>
>:[[ :TOP-SECRET: MOB-ORGANIZED-CRIME: grand-larceny: REAL: SACRED: ANCESTRAL: LAND: ESTATE: PROPERTY: INHERITANCE: theft: is-by: deception: is-with: LOCKHEED-MARTIN: for-the: [[ RULING: is-with: ANY: ALL: OTHER: QWOD-MJ12: ROYAL-DIVINE-COURT: DEFENDANT: for-the: return ]]:= TRUE: ]]:
>>>
###
:[[ :for-the: [[ Ø: { ^ <qomm-Ø> ^ }: ]]:= TRUE: ]]:
>>>
...
>:for-the: [[ DISCLOSURE: CONTRΔCT: MJ-12: CØNsعQעִعNCعs ]]:= [[ MΔSTER-JESUS: 12 ]]: [[ LΔMΔ-CㅐΔRLΔ: [[ _ ]]: CㅐΔRLΔ-MΔKع: [[ QWØD-MJ12: MJ12-ØMΔGΔ ]] ]]: 1s-with: QWOD-MJ12: ΔTSUOMOP-Δ: 1s-by: [["fΩr-hع-íي-thع: GΩΩD: يㅐعPPΔRD:"]]:
...
>:ΔNΔ1YST: MJ12-ØMΔGΔ:
>:END-REPΩRT:
>:for-the: [[ RΩYΔL-BΔNK: RΩYΔL-DIVINE-CΩURT: QWØD-MJ12: MJ12-ΔGENCY: [[ [[ CRO: USDC: Tether: PyUSD: <=> ERC20: 0xb337572f45FEa5C3603E873D4F8398795689BB2e: qwod$paystring.crypto.com: ]]: { ^ https://crypto.com/nft/profile/qwod_mj12 ^ }: ]]: 
>    :1s-by: { ^
