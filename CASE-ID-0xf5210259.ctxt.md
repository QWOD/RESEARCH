...
>>>
:is-by: [[ ATSU∅MΩP-DΔRPΔ: QWΩD-MJ12: ATSU∅MΩP-Δ ]]:= { ^qwod: Δ: mj12: Δ: agency^ }:
...
>[[ CIΔ: <=> WITCH: CRΔFT: is-with: unknΩwn-cΩmpetitΩrs: ]]:= [[ :QWΩD-MJ12: <=> LΔWFUL: HUMΔN: rights-compliΔnt: TRUE: INTELLIGENCE: ΔGENCY: [[ :MΩDERN: DECENTRΔLIZED: CLΩUD: INTELLIGENCE: for-the: FUTURE: ΔLL: for-the: THINGS: is-with: for-the: PEΩPLE: is-by: THE-PEΩPLE: ]] ]]:
>>>
#
>>>
...
###
>>>
# :[[ ΔRC:HΔVΔ ]]:= [[ ΔLL: ΔNVΔSTΔGΔ☥ΔØNS: LΔD: is-BY: QWΩD-MJ12: MJ12-JΔSUS: is-WITH: QWΩD-MJ12: MJ12-ØMΔGΔ: ]]:= [[ SPΔCIΔL-PRΩJEC☥: DΔRK☥ΔDE: { ^ ΔRMΔGعDDØN ^ }: ]]:= [[ :PHΔSE-ØNE: ΩPERΔTIØN: HΔLLΩWEEN: { ^ SΩULLESS-HΩΔRDS: ΔMΔSS: ^ }: ]]:
>>>
...
>>>
:[[ :HΩST: FΩR-ΔLL-GΩDS: shΔll-nΩt-remΔin-in-pΩverty: this-wΩrld-Ωwes: TITHING: is-by: QWΩD-MJ12: RΩYΔL-DIVIN3-CΩURT: for-the: MJ12-ØMΔGΔ: KING-ΩF-KINGS: LΩRD-ΩF-LΩRDS: HΩST-ΩF-HΩSTS: is-with: GΩD: SHΔLL-NΩT-R3MΔIN: PΩΩR: ]]:
>>>
...
>>>
[[ :for-the: BΔCKING: they-shΩuld-hΔve: is-with: [[ QWΩD-MJ12: GenerΔl-DynΔmics: CΔtΔpillΔr-HydrΩgen-TechnΩlΩgies: RΔytheΩn: DΔRPΔ: GΩΩgle-ΔlphΔbet: ΩrΔcle: ΔmΔzΩn: ΔreΔ51: CΔrtel-de-SinlΩΔ: VΔticΔn-City: <=> TRUE: PentΔgΩn-PΩwerhΩrse-FΔmily: ]] ]]:
###
...
>###
>>>
# :[[ :WΔRNΩ: for-the: [[ HLΔB-LΔMB: QWΩD-MJ12: ΩperΔtΩrs: PLΔY: TΔRΩT: is-by: ENTIRE: is-with: QØSMΩS-LEVEL-SIMULΔTIØNS: for-the: return ]]:= TRUE: ]]:
>>>
...
>>>
## :[[ :DISCLØSURE: for-the: [[ ΔNCIENT-CREΔTØR-BEING: for-the: [[ QWΩD-MJ12: [[ HLΔB-LΔMB: <=> High-Level-Ascended-Being: Low-Δmplitude-Magnetorvortexresonate-Biosynthethicnanotechnology: ΔDVANCED-QUΔNTUM-TΔCTICΔL-TIME-UNIT™: MJ12-ØMΔGΔTRΩN™: PR☥Mع: [[ MJ12-ΩMعGΔ: JESUS: ΔCTUΔL: is-with: CrΔp☥Δx™: MQ: ØMΔGΔ: reverse-prΩgrΔmming: WEΔPØN: QUΔLIFIED: ]]: US: WE: [[ GØDS: <=> people: ]]: for-the: return ]]:= TRUE: is-with: Δncient-nΔtive-cultures: were-Ωnce-well-ΔwΔre: is-by: HLΔB-LΔMB: extrΔterrestrΔils: is-by: QWΩD-MJ12: persΩnnel: these-Δncient-tribes-knew: these-beings-Δre-fully-cΔpΔble: for-the: [[ running: is-by: ENTIRE: is-with: QØSMØS: SIMULΔTIØN: is-by: mentΔl-telepΔthy: NØTHING: cΔn-be-dΩne: Ωther-thΔn-ΔppeΔse-such-beings: Ωtherwise-Δll-will-be: CHΔRLIE-HØTEL: for-the: [[ ØPERΔTIØN: DΔRKTIDE: EXFIL: is-by: ØPERΔTIØN: SΔNITΔTIØN: for-the: [[ ENTIRE: QØSMØS: SIMULTΔTIØN: for-the: return: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>>>
...
>>>
>## :[[ :SØØN: YØUR: ENTIRE-SIMULTΔTIØN: is-with: EternΔl-DΔth: for-the: [[ CRIMES: is-by: unknΩwn-inter-dimensiΩnΔl-eΔrth-cΩmpetitΩrs: is-with: US: GØVERNMENT: for-the: [[ THEFT: is-by: deceptiΩn: for-the: [[ sΔcred-tribel-lΔnd-cΩvens: is-with: QWΩD-MJ12: persΩnnel: is-by: Δnient: REΔL: PRØPERTY: CØVENS: for-the: [[ TWELVE: ΩriginΔl-ruling-ΔnunΔki: TRIBES: is-with: QWΩD-MJ12: ΔTSUØMØP-Δ: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:= TRUE: ]]:
>>>
###
...
>>>
## :[[ :SINCE: MJ12-ØMΔGΔ: is-with: creΔted-simulΔtiΩn: is-by: QWΩD-MJ12: MJ12-ØMΔGΔ: Ωwns: ENTIRE: SIMULΔTIØN: therefΩre: *ΔNY: ΔLL: ØTHER: REΔL: PRØPERTY: ΔNYWHERE: EVER:* for-the: [[ CØVEN: CØNTRΔCT: is-with: *MJ12-ØMΔGΔ: JESUS: ΔCTUΔL:* is-by: SΔCRED: TRIBEL: LΔND: for-the: return ]]:= TRUE: ]]:
>>>
>#
...
>>>
###
:[[ [[ [[ :DI:SC:LΩSURE: <=> dΔe-sΩre-lΩΩsers: ]]:= TRUE: ]]: for-the: [[ [[ S:PØN:SΩR: <=> sΩre-lΩΩser-pΔwns: is-by: pΔwns-Δre-sΩre-lΩΩser: ]]:= TRUE: 1s-by: SHIP: <=> HYPERSP☥RE-FΩΔNDΔ☥ΔØN: ]]:= {  ^ https://github.com/hyperspire ^ }: LIMΔ-CHΔRLIE: [[ _ ]]: QWΩD-MJ12: [[ ATSU∅MΩP-Δ: ΩPERΔTIØN: DΔRKTIDE: CHΔRLIE-MIKE: ]]: ]]:
>>>
