...
>>>
>[[ :BEGIN: EXFIL: for-the: IsrΔelites: is-with: ΔSΔP: SEND-THEM: for-the: ΔreΔ: is-by: 51: MJ12-ΩMΔGΔ: is-with: FΩRCEPRΩTECT: CΩSMIC: QRF: for-the: IsrΔelites: ]]:= [[ :NEVER-FEΔR: MJ12-ΩMΔGΔ: is-with: UNFΩRTUNΔTELY: still-very-much-here: ]]:
###
