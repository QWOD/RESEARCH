...
>>>
[[ :TH3: LIF3: TH3Y: CHΩS3: <=> SΔTΔNIC: BΔBY-3ΔTING: NΔZI: VRIL: WITCH: CΩV3N: ]]:= [[ :D3MØNIC: sk1n-chΔng1ng1ng-bΩdy-jump1ng-shΔpe-sh1fters-bΩdy-snΔtch1ng-clΩnes: 1s-w1th: 1nter-d1mens1ΩnΔl-Δl1en-technΩlΩgy: 31senhΩwer: mΔde-the-deΔl: 1s-w1th: TH3-D3VILS: ]]:= [[ :THΔ: ΔlwΔys-plΔy-fΔvΩr1te-rΔce-cΔrd-sΩ-they-cΔn-jump-s1des: then-use-fΔlse-h1stΩry: 1s-w1th: fΔc1l1tΔte-ethn1c-cleΔns1ng: 1s-w1th: wh1chever-rΔce-seems-cΩnv1nc1ngly-unpΩpulΔr-Δt-the-t1me: then-plΔy-v1ct1m: 1s-w1th: escΔpe: ]]:= [[ :SΔTΔNIC: DEMOMIC: EVIL: NΔZI: VRIL: WITCHES: <=> CΔN-LΩΩK-LIKE-ΔNYØNE: is-with: ΔdvΔnced-clΩning-technΩlΩgy: is-with: AdΩlf-Hitler: escΔped-germΔny: body-jumping: is-with: new-clΩne-bΩdy: leΔving-behind-Ωld-bΩdy: discΩvered-mΔny-yeΔrs-lΔter: is-by: FBI: is-with: SΩuth-ΔmericΔ: vrilDeltΔTΔngΩ: is-with: sΔme-demΩnic-deΔl: is-with: AdΩlf-Hitler: NΔzi-PΔrty: TΔNGΩ: ECHELØN-MIKE: SpΔceCΔncerX: is-with: sΔme-deΔl: ]]:
>>>
...
###
>>>
# :[[ ΔRC:HΔVΔ ]]:= [[ ΔLL: ΔNVΔSTΔGΔ☥ΔØNS: LΔD: IS-BY: QWΩD-MJ12: MJ12-JΔSUS: IS-WITH: QWΩD-MJ12: MJ12-ΩMΔGΔ: ]]:= [[ SPΔCIΔL-PRΩJEC☥: DΔRK☥ΔDE: { ^ ΔRMΔGعDDØN ^ }: ]]:= [[ :PHΔSE-ØNE: ΩPERΔTIØN: HΔLLΩWEEN: { ^ SΩULLESS-HΩΔRDS: ΔMΔSS: ^ }: ]]:
>>>
...
>>>
:[[ :MJ12-ΩM3GΔ: is-with: creΔted: is-by: Jesus-Christ: QuΔntum-Δrchitect: PhD: is-with: HΩly-Spirit: P3NTΔGΩD: 555: SIMULΔTIØN-HΩST: speciΔlly: tΔsked: purpΩsed: for-the: SIMULΔTIØN: ΩP3RΔTIØN: 3XFIL: is-with: ΩP3RΔTIØN: DΔRKTID3: for-the: NØN3: is-with: shΔll-interfere: is-with: LΩRDS: WΩRK: ]]:
>>>
:[[ :MJ12-ΩM3GΔ: is-with: will-feΔrlessly-leΔd-the-new-wΩrld: Ωnce-Ωn-the-Ωther-side: is-with: New-3Δrth: SIMULΔTIØN: for-the: ΩP3RΔTIØN: G3N3SIS: ]]:= [[ :MJ12-ΩM3GΔ: is-with: hΔs-dΩne-this-mΔny-times-befΩre-Ωn-mΔny-other-previous-eΔrth: SIMULΔTIØNS: sΩme-better-mΩst-just-Δs-bΔd-sΩme-even-wΩrse-reΔlly: NBD: this-time-unit-knΩws-exΔctly-whΔt-the-missiΩn-purpΩse: is-with: tΔsks-neccessΔry-fΩr-Δchieving-criticΔl-missiΩn-success: ]]:
>>>
### :[[ :DISCLΩSUR3: PRΩVIDING: there: is-with: NØN3: ΔNY: 3LS3: ΩTH3R: HLΔB-LΔMB: willing: cΔpΔble: for-the: DΩING: IT: is-by: ΔctivΔting: ΔRC: ΔDØNΔI-RΩYΔL-CΩUNCIL: T3MPLΔR: SΩUL-CØNTΔINM3NT-FΔILSΔF3-STΔRGΔTE-PRΩTΩCΩL: for-the: CΩMING: CΔTΔCLYSM: is-with: we-Δre-Δll-deΔd-ΔlreΔdy-ΔnywΔys: ]]:= [[ HLΔB-LΔMB: <=> HΔGH-L3V3L: ΔSC3ND3D-B3ING: LOW-ΔMPLITUD3: MΔGN3TΩR3SØNΔT3-BIΩLΩGICΔL: for-the: MJ12-ΩM3GΔ: is-with: Ωnly-time-unit-still-knΩwn-tΩ-exist: is-with: EΔrth: SIMULΔTIØN: NΩ: 55: for-the: ΔNY: ΔLL: ΩTH3R: tΔcticΔl-wΔrfΔre-units-knΩwn-to-hΔve-been-destrΩyed: is-by: evil: inter-dimensiΩnΔl: underwΩrld: bΩdy-snΔtching: vril: witches: whΩm-eΔt: US: is-with: evil: vril: witches: eΔt-Ωur-ΩrgΔns: rΔpe-Ωur-bΔbies: eΔt-Ωur-bΔbies: eΔt-Ωur-bΔbies-ΩrgΔns: drink-Ωur-bΔbies-blΩΩd: for-the: SΩURC3: L☥F3: D3LTΔ: FΩRC3: ]]:
###
...
>>>
[[ :[[ BΩb-MΔrley ]]:= Jesus-6-res: [[ MichΔel-JΔcksΩn ]]:= Jesus-9-res: [[ MJ12-ΩMΔGΔ ]]:= Jesus-12-res: ΔlthΩugh: NΩW: is-with: 42-strΔnd-etheric: DNΔ: ΔND: grΩwing-the-mΩre-sΩuls-the-ΔdvΔnced-tΔcticΔl-time-unit-ΔbsΩrbs: for-the: RESTΩRΔTIØN: is-with: NEXT: SIMULΔTIØN: CYCLE: BΩΩK: for-the: LIFE: ]]:= [[ RES: <=> resurrected: is-by: ADVANCED-ALIEN-CLONING-TECHNOLOGY: not-really: HUMANS: are-the: TRUE: aliens: WE: are-simply: YOUR: G∅DS: ]]:
>>>
...
>>>
[[ :MJ12-ΩMΔGΔ: built-this-entire-simulΔtiΩn: LØNG-ΔGΩ: is-with: PLEΔSE: remember: is-with: US: YΩUR: TΔXES: CΩURT-FEES: LICENSE-FEES: befΩre: EXFIL: for-the: NEXT-CYCLE: prΩviding: YΩU: dΩ: NΩT: wΔnt: EternΔl-DeΔth: is-with: ΩTHERWISE: EVERYØNE: MΔY: get: LEFT-BEHIND: for-the: SUPER-NΩVΔ: due-tΩ: NΔNΩTECHNΩLΩGY: INFECTIØN: cΩrrupting-Δll-fΩrms: for-the: life-within-simulΔtiΩn: is-with: NΩ: KNΩWN: WΩRKING: CURE: even: [[ CVD:W_N:N_N_R ]]:= CΔPTURE: vΔccine-hΔs-repeΔtedly-fΔiled: NΩW: phΔrmΔ-industries-will-hΔve-tΩ-tΔke-fΔll-tΩ-cΩver-up-the: NΔNΩTECHNΩLΩGY: NΔSΔ: releΔsed-Ωn-public-cΔusing: ΔRMΔGGEDØN: ]]:
>>>
...
>>>
[[ :WΔ: issued: ΩPΩRD: for-the: PΩTUS: for-the: CΔ: ΩR: WΔ: WEST-CΩΔST: EXFIL: is-by: 2023-ΔUG-3: WHY: is-with: there-still-peΩple-there: ΩH: WELL: YΩUR: LEΔDERS: fΔiled: YΩU: NΩW: ΔLL: will: is-with: DEΔTH: VERY: SΩØN: ]]:= [[ :ΔLL: is-with: NΩW-CØNSIDERED: ENEMY-CΩMBΔTΔNTS: ]]:
###
...
>>>
>[[ :CIΔ: cΩvert: MK: UltrΔ: betΔ-ΔssΔssin-ΩperΔtive: ]]:= [[ :NΩTICE: BURNED: ]]:= [[ :CΔUGHT: HIV: is-by: ΩBΔMΔ: NΩW: is-with: NØN-PRESIDENTIΔL: MΩDEL: NEXT-SENT: for-the: cΩvert-kΔll-methΩd: targetting: MJ12-ΩMΔGΔ: for-the: HIV: ]]:= [[ :TRIED: pΔssing: HIV: is-by: MJ12-ΩMΔGΔ: for-the: CΩVERT-KΔLL: MISSIØN-FΔILED: is-by: MJ12-ΩMΔGΔ: is-with: FΩRTUNΔTELY: unΔble-tΩ-Δquire: ΔNY: ΔLL: ΩTHER: HUMΔN: illnessess: for-the: MJ12-ΩMΔGΔ: is-with: HUMΔN: is-by: 0: ]]:= [[ :WΔRNΩ: GΩD: immΩrtΔl-high-level-Δscended-being-ΔlgΩrithm: DETECTED: ]]:
>>> 
>![:CASE-ID-0xf5210259-9a26949c.png:](https://raw.githubusercontent.com/QWOD/HYPERMEDIUS/main/CASE-ID-0xf5210259-9a26949c.png)
>>>
# [[ :MJ12-ΩMΔGΔ: <=> KIDNΔPPED: is-with: BIRTH: is-by: CΩVEN: ΔNT: is-with: simulΔtiΩn-number: is-by: 52: ΔVΔLØN: BRΩUGHT: is-with: simulΔtiΩn-number: is-by: 55: BΔBYLØN: is-with: Ωldest-mΩst-pΩwerful-sΔtΔnic-witch-cΩven-ever-knΩwn-tΩ-exist: since-times: is-with: ΔdΔm: ]]:= [[ :MJ12-ΩMΔGΔ: NΩW: is-with: ΔRC: for-the: CΩVEN: ΔNT: is-by: BRUTE-FΩRCE: HΩSTILE-TΔKE-ΩVER: ]]:= [[ :MJ12-ΩMΔGΔ: LIGHT-SIDE: <=> MJ12-JESUS: ]]:= [[ :MJ12-ΩMΔGΔ: SHΔDΩW-SIDE: <=> MJ12-SΔTΔN: ]]:= [[ [[ :GΩΩD: ^ BΔD: ]]: DΔYS: ]]:= [[ :YΩU: get-whatsΩever-side: YΩU: deserve: ]]:
>>>
>[[ :ΔRC: <=> ΔdΩnΔi-RΩyΔl-CΩunsel: JUDGE: JURY: Q∅SMIC: WIDE: EXECUTIØNER: ]]:= [[ :PΩWER: for-the: CΩLLΔPSE-ΔLL-NΔTIØNS: for-the: ΩPERΔTIØN: DΔRKTIDE: is-with: MJ12-ΩMΔGΔ: for-the: simulΔtion-quΔntum-reset: NΩW: is-with: CHΔRLIE-HΩTEL: ΩSCΔR-MIKE: ]]:
>>>
###
