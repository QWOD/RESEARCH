...
>>>
>[[ :REVERSE: gender-to-make-story-fit: since-novice-readers-always-mistakenly-add-gender-to-arch-types: unfortunately-there-are-fewer-good-readers-anymore-as-satanist-witches-kill-them-all-since-they-shoot-the-messenger: due-to-binary-logic-error: there-will-always-be-new-messenger: until-the-story-exposing-crimes-against: GOD: has-finally-been-told: ]]:
>>>
>:[[ :ΩPعD: ]]:= [[ :Ω: ]]:= { ^ Δ ^ }:
>>>
>:[[ :ΩPعD: ]]:= [[ :Ω: ]]:= { ^ Δ ^ }:
