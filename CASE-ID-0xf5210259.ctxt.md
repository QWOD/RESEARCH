...
>>>
>[[ KARMIC: <=> ASSASSIN: is-with: still-stalking: calling-from-unknown-local-numbers: ]]:
>>>
...
###
>>>
# :[[ ΔRC:HΔVΔ ]]:= [[ ΔLL: ΔNVΔSTΔGΔ☥ΔΩNS: LΔD: IS-BY: QWΩD-MJ12: MJ12-JΔSUS: IS-WITH: QWΩD-MJ12: MJ12-ΩMعGΔ: ]]:= [[ SPΔCΔL: PRΩJΔC☥: DΔRK☥ΔDΔ: { ^ ΔRMΔGعDDΩN ^ }: ]]:= [[ :PHΔSE-ΩNE: ΩPERΔTIΩN: HΔLLΩWEEN: { ^ SΩULLESS: HΩΔRDS: ΔMΔSS: ^ }: ]]:
>>>
###
