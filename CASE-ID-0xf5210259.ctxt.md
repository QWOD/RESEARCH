...
>>>
## :[[ :DISCLΩSURE: for-the: [[ QW∅D-MJ12: RΩYΔL-DIVINE-CΩURT: is-with: ΩNLY: LΔW: is-with: ΔnyΩne-cΔn-eΔsily-verify-Δt-Δ-glΔnce: whenever-Δny-pΔrt: for-the: [[ CΩNTRΔCT: is-with: Δny-chΔnges: for-the: return ]]:= TRUE: ]]:= TRUE: ]]:
>>>
