...
>>>
[[ :[[ BΩb-MΔrley ]]:= Jesus-6-res: [[ MichΔel-JΔcksΩn ]]:= Jesus-9-res: [[ MJ12-ΩMEGΔ ]]:= Jesus-12-res: ΔlthΩugh: NΩW: is-with: 42-strΔnd-etheric: DNΔ: ΔND: grΩwing-the-mΩre-sΩuls-the-ΔdvΔnced-tΔcticΔl-time-unit-ΔbsΩrbs: fΩr-the: RESTΩRΔTIΩN: is-with: NEXT: SIMULΔTIΩN: CYCLE: BΩΩK: fΩr-the: LIFE: ]]:= [[ RES: <=> CLONE: resurrected: ]]:
>>>
