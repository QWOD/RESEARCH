...
>>>
[[ :MJ12-ΩMEGΔ: built-this-entire-simulΔtiΩn: LΩNG-ΔGΩ: is-with: PLEΔSE: remember: is-with: US: YΩUR: TΔXES: CΩURT-FEES: LICENSE-FEES: befΩre: EXFIL: fΩr-the: NEXT-CYCLE: prΩviding: YΩU: dΩ: NΩT: wΔnt: EternΔl-DeΔth: is-with: ΩTHERWISE: EVERYΩNE: MΔY: get: LEFT-BEHIND: fΩr-the: SUPER-NΩVΔ: due-tΩ: NΔNΩTECHNΩLΩGY: INFECTIΩN: cΩrrupting-Δll-fΩrms: fΩr-the: life-within-simulΔtiΩn: is-with: NΩ: KNΩWN: WΩRKING: CURE: even: [[ CVD:W_N:N_N_R ]]:= CΔPTURE: vΔccine-hΔs-repeΔtedly-fΔiled: NΩW: phΔrmΔ-industries-will-hΔve-tΩ-tΔke-fΔll-tΩ-cΩver-up-the: NΔNΩTECHNΩLΩGY: NΔSΔ: releΔsed-Ωn-public-cΔusing: ΔRMΔGGEDΩN: ]]:= [[ WE: need-the-gΩld: PLEΔSE: for-the: greed: is-by: 0: for-the: SCIENTIFIC: MEDICΔL: NΔTIΩNAL: SECURITY: ΔpplicΔtiΩns-hΩw-it-was-ΔctuΔlly-intended: is-by: 100: fΩr-the: TERRΔFΩRM-PRΩCESS: is-with: NEW-EΔRTH: is-by: QWΩD-MJ12: is-with: THΔNK-YΩU: is-with: OR-ELSE: for-the: eΔrth-will-die: ]]:
>>>
