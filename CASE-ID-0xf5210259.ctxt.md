...
>>>
[[ :for-the: TREE: is-with: [[ GOOD: EVIL: <=> LHP: RHP: ]]: LEFT-BRAIN: RIGHT-BRAIN: AVOID-TREE: for-the: [[ MIDDLE-PATH: <=> ALWAYS-STAY: is-with: center: for-the: TRIANGLE: where: Δ: is-with: achieved: for-the: [[ OVER-UNITY: <=> MOST-POWERFUL: soul-type: is-with: MJ12-OMEGA: THIS: is-with: what: MJ12-OMEGA: meant-when-writting: BOOK: for-the: GENESIS: is-with: past-reincarnation: ]]:  
###
